...
main() {
  ...
  if [[ $theme == main ]]; then
    thm_base="#1a1b26"    # background
    thm_surface="#1f2335" # slightly lighter bg
    thm_overlay="#24283b" # surface/overlay
    thm_muted="#565f89"   # muted text
    thm_subtle="#7aa2f7"  # accent/subtle blue
    thm_text="#c0caf5"    # foreground / main text

    thm_love="#f7768e" # red/pink
    thm_gold="#73daca" # gold/yellow
    thm_rose="#bb9af7" # purple
    thm_pine="#9ece6a" # green
    thm_foam="#7dcfff" # cyan
    thm_iris="#7aa2f7" # blue

    thm_hl_low="#292e42"  # low highlight
    thm_hl_med="#3b4261"  # medium highlight
    thm_hl_high="#565f89" # high highlight
